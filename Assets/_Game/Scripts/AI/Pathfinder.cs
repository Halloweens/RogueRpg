...
public class Pathfinder : MonoBehaviour 
{
    ...
    {
        yield return StartCoroutine(FindPath(startPos, endPos, listMethod));
    }

    public IEnumerator FindPath(Vector3 startPos, Vector3 endPos, Action<List<Vector3>> listMethod)
    {
